    ...
    <div className="section-wrapper">
      <div className="obj-wrapper">
        ...
        <div className="user-obj-footer">
          <button className="borrar" style={{ fontSize: '24px', color: 'red' }}><i className="fa fa-trash-o"></i></button>
          <button className="editar" style={{ fontSize: '24px', color: 'green' }}><i className="fa fa-edit"></i></button>
        </div>
      </div>
